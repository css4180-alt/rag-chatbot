<template>
  <aside class="doc-panel">
    ...
    <section class="doc-section">
      ...
      <label id="tutorial-global-doc" class="upload-btn" :class="{ loading: uploadingGlobal }">
    ...
    <section class="doc-section">
      ...
      <template v-if="hasSession">
        <label id="tutorial-session-doc" class="upload-btn" :class="{ loading: uploadingSession }">
